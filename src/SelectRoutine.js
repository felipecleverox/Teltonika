...
import historicalMovementsImage from './assets/images/historical_movements.png';
    ...
    <div className="select-routine">
      ...
      <div className="routine-sectors">
        <div className="routine-row">
          ...
          <div className="routine-sector">
            <div className="routine-title">Busqueda Histórica en Interiores</div>
            <img 
        ...
        <div className="routine-row second-row">
          ...
          <div className="routine-sector">
            <div className="routine-title">Busqueda Histórica en Exteriores</div>
            <img 
